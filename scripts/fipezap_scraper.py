...
if __name__ == "__main__":
    ...
    # Pega APENAS o relatório do mês mais recente (1 mês) para máxima performance
    downloaded_files = asyncio.run(scraper.run(num_months=1))
    logging.info(f"Processo concluído. Arquivos verificados: {downloaded_files}")
